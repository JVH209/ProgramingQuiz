...
short story that includes the words the user chose.""") #added and fixed triple qutations
play = input("Do you want to play MadLibs?(y/n) ") #changed onput to input
if play == "y": #added another = to do comparison and colon to show what to do when conditon is met
    person_name = input("Choose a name for a person: ")
    place = input("Choose a place: ")
    noun_1 = input("Choose a singlular noun: ")
    animal_1 = input("Choose an animal: ") #added quotation marks
    ...
    hiking on the """ +adjective_2+""" trail. If I see a """ +adjective_3 +""" """ #changed place to the string place
    +animal_2+"""
